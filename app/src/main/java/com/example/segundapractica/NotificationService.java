...
/*Muestra la notificacion en la barra de estado*/
public class NotificationService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent2) {
        ...
        /*Si esta corriedo en un dispositivo por encima de android oreo*/
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(getString(R.string.app_name)).setCategory(Notification.CATEGORY_SERVICE)
                    .setSmallIcon(R.drawable.ic_baseline_notifications_24)   // required
                    .setContentText(message)
                    .setLargeIcon(BitmapFactory.decodeResource(res, R.drawable.ic_baseline_notifications_24))
        ...
        /*Si corre en un dispositivo que esta por deajo de android Oreo*/
        } else {
